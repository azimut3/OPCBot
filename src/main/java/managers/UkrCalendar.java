...
public class UkrCalendar {
    ...
    public static String getMinutes() {
        return String.valueOf(Integer.parseInt(formatMinutes.format(getCalendar().getTime())) + 2);
    }

    public static String getDay() {
        return String.valueOf(Integer.parseInt(formatDay.format(getCalendar().getTime())) + 2);
    }
