...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="opcBot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" OdessaPortCheckApplication %CMD_LINE_ARGS%
